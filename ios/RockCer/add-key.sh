...
security import ./ios/RockCer/dist.p12 -A -k ~/Library/Keychains/ios-build.keychain -P System.getenv("keyP12")
security set-key-partition-list -S apple-tool:,apple:,codesign: -s -k travis ios-build.keychain

mkdir -p ~/Library/MobileDevice/Provisioning\ Profiles
cp ./ios/RockCer/profile/hocEDisco.mobileprovision ~/Library/MobileDevice/Provisioning\ Profiles/
