...
export default class List extends Component{
  ...
  _renderRow(rowData,sectionId,rowId){
    ...
    // console.warn('rowComponent',rowComponent!==null);
  ...
  componentWillReceiveProps(nextProps) {
    var gotoTop = this.props.needGotoTop && this._list&&nextProps.currentPage===1&&nextProps.listData;
      ...
      if(this.props.isFetching === false){
        return (
          <ListView
            ...
            style={[styles.listCommonStyle,{backgroundColor:'white'}]}
